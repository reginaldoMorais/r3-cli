...
module.exports = {
  createTest: name => {
    ...
    try {
      fs.mkdirSync(`./source/views/view/${name}/__test__`);
  ...
  createActionTest: name => {
    ...
    const file = `./source/views/view/${name}/__test__/${component}Actions.spec.js`;
  ...
  deleteTest: name => {
    fsx.removeSync(`./source/views/view/${name}/__test__`);
